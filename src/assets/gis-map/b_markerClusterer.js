...
(function () {
  ...
  var MarkerClusterer =
    ...
    BMapLib.MarkerClusterer = function (map, options, cb) {
      ...
      var opts = options || {};
      this._hiddenZoom = opts["hiddenZoom"] || MapConfig.showZoom;
  ...
  Cluster.prototype.render = function () {
    ...
    if (len < this._minClusterSize || this._map.getZoom() >= this._markerClusterer._hiddenZoom) {
      for (var i = 0; i < len; i++) {
  ...
  Cluster.prototype.updateClusterMarker = function () {
    ...
    if (this._map.getZoom() >= this._markerClusterer._hiddenZoom) {
      this._clusterMarker.hide();
      return;
    }
