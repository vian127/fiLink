...
import {
  ...
  DEVICE_SERVER_XKD, EQUIPMENT_SERVER,
...
const DEVICE_PREFIX = `${COMMON_PREFIX}${DEVICE_SERVER_XKD}/deviceInfo`;
const DEVICE = `${COMMON_PREFIX}${DEVICE_SERVER}`;
...
const DEVICE_LOG = `${COMMON_PREFIX}${DEVICE_SERVER_XKD}/deviceLog`;
const PICTURE_VIEW = `${COMMON_PREFIX}${DEVICE_SERVER}/picRelationInfo`;
const SMART_TEMPLATE = `${COMMON_PREFIX}${SMART_SERVER}/template`;
const SMART_INFO = `${COMMON_PREFIX}${SMART_SERVER}`;
const CORE_END = `${COMMON_PREFIX}${SMART_SERVER}`;
const CONTROL = `${COMMON_PREFIX}${LOCK_SERVER}/control`;

const DEVICE_PREFIX_XKD = `${COMMON_PREFIX}${DEVICE_SERVER_XKD}/deviceInfo`;
...
// 查询设施类型数量
export const QUERY_DEVICE_TYPE_COUNT = `${DEVICE_SERVER_XKD}/statistics/queryDeviceTypeCount`;
// 新增设施信息
...
// 查看设施详情
export const FIND_DEVICE_BY_ID = `${DEVICE_PREFIX}/queryDeviceInfo`;
// 获取设施配置策略
...
export const GET_MODEL = `${DEVICE_PREFIX_XKD}/getDeviceModelByType`;
// 名称自动生成
export const AUTO_DEVICE_NAME =  `${DEVICE_PREFIX_XKD}/getDeviceNameByCityAndType`;
// 设施详情挂载设备概览列表
export const QUERY_MOUNT_EQUIPMENT = `${COMMON_PREFIX}${DEVICE_SERVER_XKD}/equipmentInfo/queryEquipmentInfoList`;
// 编辑设施
export const UPDATE_DEVICE_BY_ID = `${DEVICE_PREFIX}/updateDeviceById`;
// 删除设施
export const DELETE_DEVICE_BY_IDS = `${DEVICE_PREFIX}/deleteDeviceByIds`;
// 上传图片
export const UPLOAD_IMG = `${COMMON_PREFIX}${EQUIPMENT_SERVER}/picRelationInfo/uploadImageForLive`;
// 查询项目列表
