...
const routes: Routes = [
  ...
  // {path: 'xx', loadChildren: './business-module/business.module#BusinessModule', canActivateChild: [RoleDeactivateGuardService]},
  {path: 'business', loadChildren: './business-module/business.module#BusinessModule'},
  {path: 'xx', loadChildren: './business-module/business.module#BusinessModule'},
