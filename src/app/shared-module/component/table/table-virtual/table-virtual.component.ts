...
import {AreaLevelEnum} from '../../../../business-module/facility/share/const/facility.config';
    ...
    if (changes.dataSet) {
      ...
      if (this.tableConfig.columnConfig[0].type === 'expend') {
        ...
        this.dataSet.forEach((item, index) => {
          ...
          const areaLevelName = this.i18n.translate(`facility.config.${AreaLevelEnum[item[this.levelKey]]}`);
          ...
          if (item[this.tableConfig.columnConfig[0].expendDataKey] && item[this.tableConfig.columnConfig[0].expendDataKey].length > 0) {
            ...
            (function setFather(data) {
              data[that.tableConfig.columnConfig[0].expendDataKey].forEach((_item, _index) => {
                ...
                const _areaLevelName = that.i18n.translate(`facility.config.${AreaLevelEnum[_item[that.levelKey]]}`);
