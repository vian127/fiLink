...
import {getDeployStatus, getDeviceType, getDeviceStatus} from 'src/app/business-module/facility/share/const/facility.config';
import {NzI18nService} from 'ng-zorro-antd';
import {Result} from '../../../shared-module/entity/result';
import {AlarmObjectConfig} from '../alarm/alarmSelectorConfig';
...
export class DeviceObjectComponent implements OnInit {
  ...
  pageBeanObject: PageBean = new PageBean(10, 1, 1); // 分页
  ...
  refreshObjectData(body?) {
    ...
    console.log(this.queryConditionObj);
