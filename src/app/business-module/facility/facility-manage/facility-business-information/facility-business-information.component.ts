...
import {DeviceTypeCode, getTemplateCodeRule, getTemplateTrend} from '../../share/const/facility.config';
import {SmartService} from '../../../../core-module/api-service/facility/smart/smart.service';
import {Result} from '../../../../shared-module/entity/result';
import {TemplateReqDto} from '../../../../core-module/model/facility/template';
...
export class FacilityBusinessInformationComponent implements OnInit {
  ...
  // 模板实体
  public templateReqDto: TemplateReqDto;
  // 模板禁用
    ...
    this.$smartService.queryFacilityBusInfoById(this.deviceId, this.deviceType).subscribe((result: Result) => {
      ...
      if (result.code === 0) {
        if (result.data.boxList && result.data.boxList.length > 0) {
          ...
          if (this.deviceType === DeviceTypeCode.opticalBox || this.deviceType === DeviceTypeCode.distributionFrame) {
