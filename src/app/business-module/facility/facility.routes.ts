...
export const ROUTER_CONFIG: Routes = [
  {
    ...
    children: [
      ...
      { // 设备列表
        ...
        data: {
          breadcrumb: [{label: 'facilityManage'}, {label: 'equipmentManage'}]
        }
      },
      { // 新增或编辑设备信息
        ...
        data: {
          breadcrumb: [{label: 'facilityManage'}, {label: 'equipmentManage', url: 'equipment-list'}, {label: 'equipment'}]
        }
      },
      { // 查询设备详情
        ...
        data: {
          breadcrumb: [{label: 'facilityManage'}, {label: 'equipmentManage', url: 'equipment-list'}, {label: 'equipmentDetail'}]
        }
      },
      { // 网关配置
        path: 'gateway-config',
      ...
      { // 分组列表
        ...
        data: {
          breadcrumb: [{label: 'facilityManage'}, {label: 'groupManage'}]
        }
      },
      { // 新增或者编辑分组信息
        ...
        data: {
          breadcrumb: [{label: 'facilityManage'}, {label: 'groupManage', url: 'group-list'}, {label: 'group'}]
        }
      },
    ]
  }
