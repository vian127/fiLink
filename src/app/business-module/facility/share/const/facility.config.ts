...
export enum DeviceTypeCode {
  opticalBox = '001', // 光交箱(有锁)(有智能标签)
  wisdom = '002', // 智慧杆
  distributionPanel = '003', // 配电箱
  well = '030', // 人井(有锁)
  distributionFrame = '060', // 配线架(有智能标签)
  junctionBox = '090', // 接头盒(有智能标签)
  outdoorCabinet = '210' // 室外柜 (有锁)
}
...
export function getTemplateTrend(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(TemplateTrend, i18n, code);
}

export function getTemplateCodeRule(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(TemplateCodeRule, i18n, code);
}


export function getNodeObjectType(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(nodeObjectType, i18n, code);
}

export function getAlarmCleanStatus(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(alarmCleanStatus, i18n, code);
}
...
export function getCableDeviceType(i18n: NzI18nService, code = null): any {
  return CommonUtil.codeTranslate(CableDeviceTypeCode, i18n, code);
}

export function getIsConfirm(i18n: NzI18nService, code = null): any {
  return CommonUtil.codeTranslate(isConfirm, i18n, code);
}
...
export function getDisableAndEnable(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(DisableAndEnable, i18n, code);
}

export function getAlarmLevelName(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(AlarmLevelName, i18n, code);
}

export function getPartsType(i18n: NzI18nService, code = null): any {
  return CommonUtil.codeTranslate(PartsTypeCode, i18n, code);
}
...
export function getAreaLevel(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(AreaLevel, i18n, code);
}

export function getLogType(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(logType, i18n, code);
}

export function getSensorValue(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(sensorValue, i18n, code);
}

export function getCableLevel(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(cableLevelCode, i18n, code);
}

export function getTopologyName(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(topologyCode, i18n, code);
}

export function getWiringType(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(wiringTypeCode, i18n, code);
}

export function getCableSectionStatus(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(cableSectionStatus, i18n, code);
}

export function getSourceType(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(sourceType, i18n, code);
}

export function getSolarCell(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(solarCell, i18n, code);
}

export function getOperator(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(operatorEnum, i18n, code);
}
export function getSimPackageType(i18n: NzI18nService, code = null): any {
  return CommonUtil.codeTranslate(SimPackageType, i18n, code);
}
...
export function getDesignateType(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(designateTypeEnum, i18n, code);
}
export function getDesignateReason(i18n: NzI18nService, code = null) {
  return CommonUtil.codeTranslate(designateReasonEnum, i18n, code);
}
