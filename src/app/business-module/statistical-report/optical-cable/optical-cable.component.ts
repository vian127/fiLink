...
import {NzI18nService, NzMessageService, NzModalService, NzTreeNode} from 'ng-zorro-antd';
...
import {getDeployStatus, getDeviceStatus, getDeviceType, getSensorValue} from '../../facility/share/const/facility.config';
...
export class OpticalCableComponent implements OnInit {
  ...
  // 进度条
  ProgressShow = false;
  section_pageBean: PageBean = new PageBean(10, 1, 1); // 分页
  section_queryCondition: QueryCondition = new QueryCondition(); // 分页条件
  section_tableConfig: TableConfig; // 表格配置
  // 选择光缆段modal模板
